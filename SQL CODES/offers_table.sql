...
CREATE TABLE `offers_table` (
  ...
  `offer_condition` varchar(200) DEFAULT NULL,
  `offer_discount` varchar(100) DEFAULT NULL,
...
LOCK TABLES `offers_table` WRITE;
/*!40000 ALTER TABLE `offers_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `offers_table` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-15 12:00:54
